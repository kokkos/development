...
## Notes
- HPSF Community Event 2026: Daniel going, 30 participants
- Kokkos Developer Meeting (https://kokkos.org/community/events/2026-03-09-developers-meeting/)
  - Patrick might be there
- Launching an education working group at KUG
- HPSF Conference:
  - all good, under control
  - talk about Kokkos Comm
- Can push CDash notes and search them for build configurations
  - isn't available on mycdash yet
- 5.1.0 release:
  - some time in March
  - do self-similar interface? Needs reviews (https://github.com/kokkos/kokkos/pull/8367)
  - do mdspan-arguments for View? Needs reviews (https://github.com/kokkos/kokkos/pull/8852)
  - release manger: Seyong
- Debug build descriptions
  - Want to retain current format
  - Move suggestions to Debugging section 
- #8731: almost ready: Conrad to work wirh Adrien
- #8689: we want execution space instances to be device-copyable
