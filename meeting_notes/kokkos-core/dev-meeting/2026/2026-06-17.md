## Wednesday, June 17, 2026 Kokkos Developer Meeting
...
- MDRangePolicy Improvement, which PRs need reviews?
...
- 5.2.0 Release
  - Adding PRs to "Blocks Promotion" as a way to prioritize, not necessarily blocking  
    - PR 9258: DongHun and/or Trevis will help debug
    - PR 9239: DongHun and/or Trevis will help debug
    - PR 9219: Needs reviews, it is in final form. Daniel and Jakob will help address final fails. Jakob will update desul when it is ready.
    - Christian has follow on for mdspan new args: changing typedefs to not lose extents info, that he wants to get in
    - PR 9264: Draft, Allowing Cuda13 and C++23 
      - Christian thinks not necessary for release
      - Damien thinks it is worth the extra effort, could fix a potential bug
    - PR 9250: Should be ready, Christian will give one last look over it
    - PR 8721: Damien would rather wait on this one unless we have high degree of confidence, Christian is in favor of merging
    - PR 8629: Defer till after, but potentially merge 8721
    - PR 8123: Too late for 5.2
    - PR 8953: Merge after 5.2
- Memory Space instances
  - Progress will be priority for 5.3
  - Issue containing notes, don't hesitate to enter the discussion
- PR 9252: Christian will take a look
