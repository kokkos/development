...
- Plan to remove legacy view implementation in 5.3
- Remove deprecated code 4
  - MemoryManaged
  - kokkos_check(OPTIONS CUDA_LAMBDA) breaking code downstream (see https://github.com/ECP-copa/Cabana/issues/866 and https://github.com/dealii/dealii/pull/19456)
  - go over the leftover
