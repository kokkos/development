...
- Compiling with Cuda-13.1: https://github.com/kokkos/kokkos/pull/8801
...
- CEA training:
  - going well
  - pretty much full attendance
  - more beginner-focussed, normal tutorial often too hard
  - help with C++, a lot of people only know python
  - maybe organize training-related talks at KUG
- HPCAsia
  - Julien, Luc, Damien, Yuuichi, Paul Zehner   attending
  - tutorial on Monday
- HPSF Community Summit
  - open for submission
- developer meeting
  - need to get a list of participants to get access to SNL
  - Luc to set up a Google Doc
- HPSF Conference
  - should have enpugh submission now
  - PC meeting later this week
- CI WG
  - want all builds to use examples
  - shifting some builds from jenkins to SNL and Permlutter
- 5.0.2
  - Cuda 13.1 fix
- 5.1
  - math functions
  - MDRangePolicy with no tiling
- minimum amount of memory needed for supporting Kokkos
  - no limit for Kokkos itself
  - tests more challenging
  - Prateek wants to write a tool that fails when requesting too much memory
  - seek help from the CI WG
- Cuda-13.1 changes include SVE updates that have been added only in the 5.x series
- stream-like benchmark #8462 is blocked need more attention from Christian
- #8768 still needs discussion. We acknowledge that helping users with erro reporting on the device-side is important but it's difficult.
