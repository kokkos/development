## Wednesday, February 4, 2026 Kokkos Developer Meeting
...
- Dev Meeting:
  - Christian will forward the list of names to get access today
  - Hackathony style the first days and last two days will be strategic planning
  - Topics see https://github.com/kokkos/development/blob/main/meeting_notes/leadership/notes/26_02_03.md
  - If anyone has input/topics, please post to #nucleus **Assignee: ALL**
  - For the most parts zoom-call ins will be possible

- No 5.0.3

- 5.1 tentative release date is beginning of March.
  - Prios: Math functions, self-similar interface, new view, Cuda 13 fixes 

- Travis: View not compatible with std::ranges. Christian: no plans to do this, even mdspan does not have it. The main problem is with the mapping multidimensional to singledimensional. Nic: just columns or rows could be represented as range. But there are a lot of questions with respect to continuous, etc.

- Meeting ended 30 mins short
