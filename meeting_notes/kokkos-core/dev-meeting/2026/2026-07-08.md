## Wednesday, July 08, 2026 Kokkos Developer Meeting
...
- **Absences**
  ...
  - Trévis
    - July 13 - 14 (national holiday, CEA closed)
...
- MDRangePolicy Improvement, which PRs need reviews? [8721](https://github.com/kokkos/kokkos/pull/8721)
    - Make time for reviewing this PR. It will be useful for SC workshop submission in the first week of August.
...
- Testing
  - HPSF nightlies have SYCL fails
  - Daniel will open issue for these
- Release
  - RC has been created
  - We should start downstream testing
  - Targeting July 28? Maybe too soon?
  - Nathan starting Trilinos testing and update PR
  - Nic opening the changelog PR and closing the issue
  - Yuichi: KokkosTools in release?
    - Damien: bug report needs to be looked at (PR #326), votes against adding it
    - Christian: votes we tag release
    - Damien: should we add integration tests?
    - Jakob: We need to create some responsibility for KokkosTools (no one owns it)
    - Christian: Let add some sanity testing on different backends, tag a release, start to have changelogs
    - Damien: Will run ArborX on AMD
    - Cedric/Hari: will find CEA machine
    - Christian: will test Cuda among others on Sandia machines
    - Rahul: will also run tests
- 5.3
  - Removing legacy view
  - Remove all remaining deprecated code 4
  - Christian: Kokkos::single PR 8123, GTEST framework PR 9252, and self-similar are priorities
  - Jakob: We should target RNG stuff 
    - Cedric: We have 2 post docs porting 2 Monte Carlo applications to Kokkos
