## Wednesday, November 26, 2025 Kokkos Developer Meeting
...
## 4.7.2 Release
  ...
  - Deprecate cudaMemAdvise_v2 on CUDART > 13000: https://github.com/kokkos/kokkos/pull/8707
...
- MDRangePolicy performance improvement is high priority
  ...
  - Refactoring of device iterate tile https://github.com/kokkos/kokkos/pull/8638
    * PR completely ready for review, doesn't change anything about how the user uses MDRangePolicy.
...
- HPSF Community Summit 2026
  - Daniel Arndt and Chris Siefert going
  - Someone from LANL maybe able to travel
- HPSF Conference
  - Right now only generla submissions possible
  - Need to figure out submissions for KUG in particular.
- Christian on jury duty
- Lab closures:
  - Oak Ridge: minimal
  - CEA: 12/23 - 01/02
  - Sandia: 12/22 - 01/02
  - LANL: 12/25 - 1/4
- CI mostly fine
  - SNL HPX to be checked (might need admin intervention; not before Monday)
  - Nightlies looking good apart from spack+Cuda (expected)
  - Trying to figure out integration testing with Trilinos (16.2 without Kokkos 5, Trilinos 17 with Kokkos 5 and C++20)
  - Nathan to work on Kokkos 5 in Trilinos, Christian to help with compiler issues (ranges header, etc.)
- Wait with removing View specializations in Trilinos for a while (until Trilinos 17 has been tested in downstream apps), might be Kokkos 5.1 or 5.2.
- March-April 2026: Trilinos audit for illegal impl etc. type usage of Kokkos
- Release 4.7.02 in the next week
- cppcoreguidelines-special-member-functions:
  - want to do it
  - review it carefully
  - add tests for moved-from state elsewhere
- #8638 needs reviews, MDRange-related refactory
