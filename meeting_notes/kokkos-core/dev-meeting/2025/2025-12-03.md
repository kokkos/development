...
- **Absences**
  ...
  - Trévis
    - December 5th - December 8th (might be absent longer, don't know yet)
...
- HPSF 26
  - Send out announcement to mailing lists at various institutions (Conrad will follow up with each institution)
  - Before Christmas break, Kokkos team suggestions for submissions
  - We probably rely more on user submissions
- HPSF Community Summit
  - ORNL is trying to send Daniel
- CEA training
  - Cedric: A lot of registration activity, close to full capacity, both industry and university
  - Christian: Would be nice for after-the-fact blog post
- CI: Daniel appointed co-chair with Nathan
- 4.7.2 Bug fixes
  - Ready for release
  - Nathan: leaving some runners in place for 4.7.2
- 5.0.1
  - Jakob: 8707 is also candidate for 5.0.1
- Christian will create release candidate for both 4.7.2 and 5.0.1
- Kokkos 5 paper
  - Patrik: we have no kokkos 4 paper, would be nice to have 5 so we don't have to cite all the way back to 3
  - Damien: JOSS doesn't care or expect to have Kokkos 4,5,6,etc. without dramatic changes
- Kokkos tutorial
  - Damien: Would like to publish anytime new push to main to point users to (tutorials, release briefing, etc.)
  - Need someone to look into this, Patrik volunteered
  - Christian: Would tags be useful? So someone watching a past tutorial can check out exact past version
  - Yes
- Daniel: should Kokkos core have a latest tag?
  - Damien: Would rather not have, users should need to figure out
  - Christian: couldn't have script that gets latest release with only git commands
  - Damien: latest tag does not completely address Stan's request(?), but it's close
  - Christian: add to his to-do list
  - Daniel, Christian: think it is useful enough
