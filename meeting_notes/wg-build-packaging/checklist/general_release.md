...
1. Update spack package following [`spack_release.md`](https://github.com/kokkos/development/new/main/meeting_notes/wg-build-packaging/checklist/spack_release.md) checklist
...
2. Add the release to godbolt following [`godbolt_release.md`](https://github.com/kokkos/development/new/main/meeting_notes/wg-build-packaging/checklist/godbolt_release.md) checklist
