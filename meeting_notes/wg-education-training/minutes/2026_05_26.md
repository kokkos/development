...
1. [x] Christian to send Patrick his two presentation slides with the Kokkos
   usage / contributors piecharts and description of HPSF.
1. [x] Work on remainder of [issue 156][issue-156]:
   1. Render PDFs for kokkos/development
1. [x] Start updating module 1; attempted summary of minutes above:
