...
- [x] Patrick and Damien to meet separately this week about the priority list of
  ...
  another issue separate from the tutorial long term plan [issue
  #164][issue-164].
   - [x] Marked [issue #162 for module 1][issue-162] with "**after SC**";
     focusing first on PRs for module 1, then will focus on [issue #166 for
     module 2][issue-166].
