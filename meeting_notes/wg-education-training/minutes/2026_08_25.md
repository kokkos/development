...
- [x] Continue creating PRs for Modules 1–2 (highlighted in issues
  [#162][issue-162] and [#166][issue-166], respectively).
- ~Create new top-level kokkos/kokkos-tutorials issue for priority work for SC26
  tutorial that needs to be finished and submitted by 2026-10-26.  (Christian)~
  Marked items on the original module 1 issues with **after SC**.  (Patrick)
