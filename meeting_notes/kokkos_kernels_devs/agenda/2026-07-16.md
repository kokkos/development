# Thursday, July 16th, 2026 Kokkos-Kernels Developer Meeting
...
Target release candidate: mid July

Target release: late July

Release briefing: First week of August (Aug 4th 11am EST)

- ~~Junchao's issue with atomics function warning was not picked up in 5.1.1 but will be in 5.2~~
- Look at more ArmPL support in conjunction with CI work, delayed by random failures of CI build, **will be regret** for next release or a patch fix?
- Junchao: noticed some deprecation warning with a recent CUDA 13.3 build, let us have a look before the release!
  - Luc: we have an image at Sandia to run this configuration, will now need to look at the warning, can still get it done for 5.2 I think...
...
- BLAS trmm is not supporting TPLs and does not allow rectangular matrices : (

- scal batch/blas location? Should it move or should other kernels move?
