...
- refactoring TeamVectorGEMM:
  - PR [#2628](https://github.com/kokkos/kokkos-kernels/pull/2628) waiting for #3085 then will be rebased

- Reintroduce ConjTrans support for TeamGemm:
  - PR [#3085](https://github.com/kokkos/kokkos-kernels/pull/3085) --> ready for review
 
- Refactor batched dot:
  - PR [#3110](https://github.com/kokkos/kokkos-kernels/pull/3110) --> Merged
